  ...
  <form class="mt-8 space-y-6" v-on:submit.prevent="register" @submit="checkForm">
    ...
    <div class="-space-y-px">
      ...
      <div class="my-5">
        ...
        <p class="errors text-red-700" v-if="!!errors.firstname">{{ errors.firstname }}</p>
      </div>
      ...
      <div class="my-5">
        ...
        <p class="errors text-red-700" v-if="!!errors.lastname">{{ errors.lastname }}</p>
      </div>
      ...
      <div class="my-16">
        ...
        <input aria-describedby="passwordHelp" @blur="validate('password')" @keypress="validate('password')"
      ...
      <div class="my-16">
        ...
        <p class="errors text-red-700" v-if="!!errors.passwordConfirmation">{{ errors.passwordConfirmation }}</p>
      </div>
    </div>
    <button
